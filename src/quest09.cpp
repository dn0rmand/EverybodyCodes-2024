...
static unsigned int part3() {
  ...
  unsigned int total = 0;
  int modulos[] = {101, 100, 75, 74, 50, 49, 38, 37, 30, 25,
                   24,  20,  16, 15, 10, 5,  3,  1,  0};
...
void quest09() {
  ...
  unsigned int d1 = quest09_namespace::part1();
  printf("\tPART 1 = %u\n", d1);

  unsigned int d2 = quest09_namespace::part2();
  printf("\tPART 2 = %u\n", d2);

  unsigned int d3 = quest09_namespace::part3();
  printf("\tPART 3 = %u\n", d3);
}
