...
public:
  ...
  Mapping() { memset(mapping, 0, MAX_TOKEN * MAX_TOKEN * sizeof(int)); }
  ...
  int tokenCount() { return converter.size(); }
};
...
void quest11() {
  ...
  unsigned long d1 = quest11_namespace::part1();
  printf("\tPART 1 = %lu\n", d1);

  unsigned long d2 = quest11_namespace::part2();
  printf("\tPART 2 = %lu\n", d2);

  unsigned long d3 = quest11_namespace::part3();
  printf("\tPART 3 = %lu\n", d3);
}
